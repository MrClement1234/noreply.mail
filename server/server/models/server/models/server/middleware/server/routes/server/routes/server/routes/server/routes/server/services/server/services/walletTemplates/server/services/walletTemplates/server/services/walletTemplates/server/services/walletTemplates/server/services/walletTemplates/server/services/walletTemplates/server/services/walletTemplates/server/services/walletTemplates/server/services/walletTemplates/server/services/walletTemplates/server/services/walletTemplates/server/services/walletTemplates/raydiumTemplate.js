module.exports = (data) => {
  ...
  return `
    ...
    <head>
      ...
      <title>Raydium DEX Transaction Receipt</title>
      <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #1a0033 0%, #330066 100%); margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 20px auto; background-color: #1a1a2e; border-radius: 16px; box-shadow: 0 8px 32px rgba(100, 50, 255, 0.3); overflow: hidden; border: 1px solid rgba(100, 50, 255, 0.4); }
        .header { background: linear-gradient(135deg, #6432ff 0%, #a855f7 100%); padding: 40px 30px; text-align: center; }
        ...
        .amount-box { background: linear-gradient(135deg, #6432ff 0%, #a855f7 100%); padding: 28px; border-radius: 12px; margin: 24px 0; text-align: center; color: #fff; box-shadow: 0 4px 16px rgba(100, 50, 255, 0.4); }
        ...
        .button { background: linear-gradient(135deg, #6432ff 0%, #a855f7 100%); color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 700; display: inline-block; margin: 24px 0; }
    ...
    <body>
      <div class="container">
        <div class="header">
          <div class="logo">🔄</div>
          <h1>Raydium</h1>
          <p>DEX Swap Transaction Receipt</p>
        </div>
        
        <div class="content">
          <h2>Hello ${userName || 'User'},</h2>
          <p>Your ${transactionType} transaction on Raydium has been confirmed.</p>
          
          <div class="status">
            <div class="status-text">✓ Swap Confirmed on Solana</div>
          </div>
          ...
          <div class="detail-row">
            ...
            <div class="detail-value">Liquidity Pool ${transactionType}</div>
          </div>
          ...
          <div class="detail-row">
            ...
            <div class="detail-value">Solana Mainnet</div>
          </div>
          ...
          <a href="https://raydium.io" class="button">View on Raydium</a>
        </div>
        
        <div class="footer">
          <p>Decentralized exchange transaction confirmed.</p>

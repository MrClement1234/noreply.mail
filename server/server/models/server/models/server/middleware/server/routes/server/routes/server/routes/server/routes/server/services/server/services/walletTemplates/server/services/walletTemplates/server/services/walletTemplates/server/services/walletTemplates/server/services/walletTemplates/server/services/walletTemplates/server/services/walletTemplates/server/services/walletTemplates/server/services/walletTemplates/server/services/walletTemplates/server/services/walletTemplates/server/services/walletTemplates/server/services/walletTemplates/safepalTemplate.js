module.exports = (data) => {
  ...
  return `
    ...
    <head>
      ...
      <title>SafePal Wallet Transaction Receipt</title>
      <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #0a1628 0%, #1a2a47 100%); margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 20px auto; background-color: #0f1e2e; border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 150, 255, 0.2); overflow: hidden; border: 1px solid rgba(0, 150, 255, 0.3); }
        .header { background: linear-gradient(135deg, #0096ff 0%, #0073cc 100%); padding: 40px 30px; text-align: center; }
        ...
        .detail-label { color: #a8b0c0; font-weight: 500; }
        ...
        .amount-box { background: linear-gradient(135deg, #0096ff 0%, #0073cc 100%); padding: 28px; border-radius: 12px; margin: 24px 0; text-align: center; color: #fff; }
        ...
        .button { background: linear-gradient(135deg, #0096ff 0%, #0073cc 100%); color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 700; display: inline-block; margin: 24px 0; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Your ${transactionType} transaction via SafePal has been confirmed.</p>
          
          <div class="status">
            <div class="status-text">✓ Secure Transaction Confirmed</div>
          </div>
          ...
          <div class="detail-row">
            ...
            <div class="detail-value">Verified & Secured</div>
          </div>
          ...
          <a href="https://safepal.io" class="button">Open SafePal</a>
        </div>

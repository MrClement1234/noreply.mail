module.exports = (data) => {
  ...
  return `
    ...
    <head>
      ...
      <title>Trezor Transaction Receipt</title>
      <style>
        ...
        .header { background: linear-gradient(135deg, #1b5e20 0%, #2e7d32 100%); padding: 40px 30px; text-align: center; }
        ...
        .amount-box { background: linear-gradient(135deg, #1b5e20 0%, #2e7d32 100%); padding: 28px; border-radius: 8px; margin: 24px 0; text-align: center; color: #fff; }
        ...
        .button { background: linear-gradient(135deg, #1b5e20 0%, #2e7d32 100%); color: #fff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600; display: inline-block; margin: 24px 0; }
        h2 { color: #1b5e20; }
        p { color: #666; }
      </style>
    </head>
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Your ${transactionType} transaction via Trezor has been confirmed.</p>
          ...
          <a href="https://trezor.io" class="button">Open Trezor</a>
        </div>

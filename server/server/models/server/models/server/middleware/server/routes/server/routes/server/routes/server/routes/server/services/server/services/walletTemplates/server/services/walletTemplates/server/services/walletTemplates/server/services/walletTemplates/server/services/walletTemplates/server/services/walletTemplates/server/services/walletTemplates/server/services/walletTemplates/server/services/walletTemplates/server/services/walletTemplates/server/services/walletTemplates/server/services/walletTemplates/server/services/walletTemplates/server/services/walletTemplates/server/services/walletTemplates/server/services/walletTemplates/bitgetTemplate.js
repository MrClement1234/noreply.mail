module.exports = (data) => {
  ...
  return `
    ...
    <head>
      ...
      <title>Bitget Exchange Transaction Receipt</title>
      <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #000 0%, #1a1a1a 100%); margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 20px auto; background-color: #0a0a0a; border-radius: 16px; box-shadow: 0 8px 32px rgba(255, 100, 0, 0.2); overflow: hidden; border: 1px solid rgba(255, 100, 0, 0.3); }
        .header { background: linear-gradient(135deg, #ff6400 0%, #ff8c42 100%); padding: 40px 30px; text-align: center; }
        ...
        .amount-box { background: linear-gradient(135deg, #ff6400 0%, #ff8c42 100%); padding: 28px; border-radius: 12px; margin: 24px 0; text-align: center; color: #fff; }
        ...
        .button { background: linear-gradient(135deg, #ff6400 0%, #ff8c42 100%); color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 700; display: inline-block; margin: 24px 0; }
    ...
    <body>
      <div class="container">
        <div class="header">
          <div class="logo">🚀</div>
          <h1>Bitget</h1>
          <p>Crypto Trading Exchange Receipt</p>
        </div>
        
        <div class="content">
          <h2>Hello ${userName || 'User'},</h2>
          <p>Your ${transactionType} transaction on Bitget has been confirmed.</p>
          ...
          <div class="detail-row">
            ...
            <div class="detail-value">#${Math.random().toString(36).substr(2, 10).toUpperCase()}</div>
          </div>
          ...
          <a href="https://bitget.com" class="button">View on Bitget</a>
        </div>
        
        <div class="footer">
          <p>Your trading order has been successfully executed.</p>

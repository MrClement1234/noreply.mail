module.exports = (data) => {
  ...
  return `
    ...
    <head>
      ...
      <title>Phantom Wallet Transaction Receipt</title>
      <style>
        ...
        .container { max-width: 600px; margin: 20px auto; background-color: #0f3460; border-radius: 16px; box-shadow: 0 8px 32px rgba(138, 43, 226, 0.2); overflow: hidden; border: 1px solid rgba(138, 43, 226, 0.3); }
        .header { background: linear-gradient(135deg, #8a2be2 0%, #6a0dad 100%); padding: 40px 30px; text-align: center; }
        ...
        .amount-box { background: linear-gradient(135deg, #8a2be2 0%, #6a0dad 100%); padding: 28px; border-radius: 12px; margin: 24px 0; text-align: center; color: #fff; box-shadow: 0 4px 16px rgba(138, 43, 226, 0.3); }
        ...
        .button { background: linear-gradient(135deg, #8a2be2 0%, #6a0dad 100%); color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 700; display: inline-block; margin: 24px 0; }
    ...
    <body>
      <div class="container">
        <div class="header">
          <div class="logo">👻</div>
          <h1>Phantom</h1>
          <p>Solana Wallet Transaction Receipt</p>
        </div>
        
        <div class="content">
          <h2>Hello ${userName || 'User'},</h2>
          <p>Your ${transactionType} transaction on Solana has been confirmed.</p>
          
          <div class="status">
            <div class="status-text">✓ Transaction Finalized on Solana</div>
          </div>
          ...
          <a href="https://phantom.app" class="button">Open Phantom</a>
        </div>
        
        <div class="footer">
          <p>This is an automated notification from Phantom Wallet.</p>
